              ...
              >
                <AccordionTrigger className="hover:no-underline py-6 group">
                  <div className="flex items-center gap-4 text-left">
                    ...
                    <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-slate-100 text-slate-600 group-hover:bg-emerald-100 group-hover:text-emerald-600 dark:bg-white/5 dark:text-slate-300 dark:group-hover:bg-emerald-500/20 dark:group-hover:text-emerald-400 transition-colors font-mono text-xs font-bold">
                      0{index + 1}
                    </div>
                ...
                <AccordionContent className="pb-6 pt-0">
                  <div className="pl-14 pr-4">
                    <p className="text-base leading-relaxed text-slate-600 dark:text-slate-300 font-light border-l-2 border-emerald-500/30 pl-6 py-1">
                      {item.description}
                    </p>
                  </div>
                </AccordionContent>
